# seckill-cluster
redis-cluster集群版+redisTemplate操纵redis,在doc文件夹里面附上了我详细搭建redis-cluster的过程。
如何使项目可访问服务器的redis-cluster，我的博客：https://blog.csdn.net/weixin_41180516/article/details/106460685
